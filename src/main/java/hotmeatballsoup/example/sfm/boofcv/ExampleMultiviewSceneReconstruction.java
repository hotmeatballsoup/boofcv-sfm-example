package hotmeatballsoup.example.sfm.boofcv;
...
public class ExampleMultiviewSceneReconstruction {
    ...
    thisDir = thisDir.substring(0, thisDir.indexOf("/."));
		String sfmHome = thisDir + "/src/main/resources/images/";
		String directory = sfmHome;
